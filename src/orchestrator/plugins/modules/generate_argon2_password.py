...
DOCUMENTATION = r'''
---
module: generate_argon2_password
short_description: Generate Argon2 password hashes
description:
  - Generates a secure Argon2 password hash from a given plaintext password using the argon2-cffi library.
options:
  password:
