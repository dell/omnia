...
short_description: Fetch validation rules for a credential field
description:
  - Loads credential validation rules from a JSON file and returns the rule for a given field.
options:
  credential_field:
    description: The credential field name to fetch rules for.
    required: true
    type: str
  module_utils_path:
