...
short_description: Fetch telemetry status from telemetry_config.yml
description:
  - Reads telemetry_config.yml and returns a list of enabled telemetry sources.
options:
  input_path:
    description: Path to the input project directory containing telemetry_config.yml.
    required: true
    type: str
'''
