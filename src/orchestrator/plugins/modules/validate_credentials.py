...
short_description: Validate credential input against rules
description:
  - Validates a credential value against predefined rules (length, pattern, character requirements).
options:
  credential_field:
    description: The credential field name to validate.
    required: true
    type: str
  credential_input:
    description: The credential value to validate.
    required: true
    type: str
    no_log: true
  module_utils_path:
...
def main():
    ...
    credentials_schema = os.path.join(module_utils_base,'orchestrator_validation','schema',\
