...
repo_manager:
  port: 2225
  certificates:
    server_crt: "<OMNIA_DATA_PATH>/pulp_config/pulp/settings/certs/pulp_webserver.crt"
    server_key: "<OMNIA_DATA_PATH>/pulp_config/pulp/settings/certs/pulp_webserver.key"
    certs_dir: "<OMNIA_DATA_PATH>/pulp_config/pulp/settings/certs"
