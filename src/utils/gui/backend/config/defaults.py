...
def get_build_stream_config_defaults() -> Dict[str, Any]:
    """Return default build stream configuration."""
    return {
...
def get_telemetry_storage_config_defaults() -> Dict[str, Any]:
    """Return default telemetry storage configuration."""
    resources_256_500 = {
    ...
    return {
        ...
        'idrac_telemetry_storage': {
            ...
            'kafka_pump': {'resources': {
                'requests': {'cpu': '50m', 'memory': '128Mi'},
                'limits': {'cpu': '200m', 'memory': '512Mi'},
            }},
            'victoria_pump': {'resources': {
                'requests': {'cpu': '50m', 'memory': '128Mi'},
                'limits': {'cpu': '200m', 'memory': '512Mi'},
            }},
        },
