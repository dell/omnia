...
# ----------------------------
# Functional group → layer mapping
# Used by generate_functional_groups.py for YAML output
# Copied from common/library/module_utils/input_validation/common_utils/config.py
# ----------------------------
