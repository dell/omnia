...
"""
Generic validation helpers for build_stream input validation.
"""
import logging
import os
...
def create_logger(log_path, project_name):
    ...
    log_file = os.path.join(
        log_path, f"build_stream_validation_{project_name}.log"
    )
    ...
    logger = logging.getLogger("build_stream_validation")
