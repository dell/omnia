...
# =============================================================================
# repo_manager — Validation Runner
# =============================================================================
# Usage:
...
#
# Options:
#   --suite <name>    Filter by subfolder (container, pulp, etc.)
...
case "$SCENARIO" in
    ...
    help|--help|-h|"")
        echo -e "${BLUE}=================================================================${NC}"
        echo -e "${BLUE}  Repo Manager — Validation Runner${NC}"
        echo -e "${BLUE}=================================================================${NC}"
        echo ""
        echo "Usage:"
        ...
        echo "  --suite <name>    Filter by subfolder (pulp, repos, etc.)"
        ...
        echo "  $0 repo_manager verify --marker sanity"
        echo ""
        echo "  # Verify only x86_64 tests"
        echo "  $0 repo_manager verify --marker x86_64"
        echo ""
        echo "  # Verify both architectures (OR)"
        echo "  $0 repo_manager verify --marker x86_64,aarch64"
        echo ""
        echo "  # Verify only x86_64 sanity tests (AND)"
        echo "  $0 repo_manager verify --marker x86_64+sanity"
        echo ""
        echo "  # Deploy validate tag and verify"
