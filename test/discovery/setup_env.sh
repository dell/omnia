...
# =============================================================================
# Discovery — Test Environment Setup
# =============================================================================
set -euo pipefail
...
echo ""
echo "================================================================="
echo "  Discovery — Test Environment Setup"
echo "================================================================="
echo ""
...
MARKER="# >>> discovery-test >>>"
MARKER_END="# <<< discovery-test <<<"
...
cat >> "${ACTIVATE_SCRIPT}" << 'DISCOVERY_ACTIVATE_EOF'
...
echo "    run_validation discovery verify --marker sanity"
echo ""
echo "  Documentation:"
