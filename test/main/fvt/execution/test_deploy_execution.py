...
TC_EX_001: Deploy omnia.sh --setup-venv (full setup, not deps-only)
"""
...
@pytest.mark.sanity
@pytest.mark.order(0)
def test_deploy_full_setup(host):
    """TC_EX_001: Deploy omnia.sh --setup-venv (full setup)."""
    ...
    result = run_omnia_cmd(host, "omnia_sh_setup_full")
