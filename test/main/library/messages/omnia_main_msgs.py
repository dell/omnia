...
Log messages, assertion messages, and function messages for the omnia.sh and
omnia-cli FVT automation. Test names and IDs live in test_case_vars.py.
"""
...
TEST_LOG_MSGS: Dict[str, str] = {
    ...
    # Venv content
    "pip_ok": (
        "All {count} required Python packages are installed"
    ),
    "pip_missing": (
