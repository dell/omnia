...
"""
Validation runner entry point for image_build_manager.
...
Usage (via run_validation.sh or run_validation CLI)::
    ...
    python3 _run.py fvt_image_build_manager build verify --marker sanity
    python3 _run.py nft_image_build_manager test
