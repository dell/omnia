...
"""Operator-facing messages for Orchestrator precheck verification."""

TEST_LOG_MSGS = {
    "playbook_success": "Orchestrator precheck completed successfully",
...
TEST_ASSERT_MSGS = {
    "playbook_failed": (
        "orchestrator.yml --tags precheck failed with rc={rc} after "
        "{duration:.1f}s. Review the playbook output and active project inputs."
    ),
    "verification_failed": (
