...
Adapted from automation_v22/automation_library/build_stream/functions/db_func.py
to use omnia_auto instead of automation_library.core.
"""

from typing import Dict, Any

from .shared_func import get_postgres_user, exec_psql_query
...
def get_job_by_id(host, job_id: str) -> Dict[str, Any]:
    ...
    query_result = exec_psql_query(
        host, container=POSTGRES_CONTAINER, db_user=pg_user,
        db_name=POSTGRES_DB, sql=sql,
    )
