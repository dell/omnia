...
def client(tmp_path):
    """
    from infra.id_generator import UUIDv4Generator  # pylint: disable=import-outside-toplevelCreate test client with mocked JWT auth and fresh DB for each test."""
