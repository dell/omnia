...
from .paths_vars import (
    ...
    GITLAB_PLAYBOOK,
    GITLAB_WORKDIR,
    GITLAB_CLEANUP_PLAYBOOK,
    GITLAB_CLEANUP_WORKDIR,
    OIM_CLEANUP_PLAYBOOK,
    OIM_CLEANUP_WORKDIR,
    BUILD_IMAGE_X86_64_PLAYBOOK,
    BUILD_IMAGE_X86_64_WORKDIR,
    BUILD_IMAGE_AARCH64_PLAYBOOK,
    BUILD_IMAGE_AARCH64_WORKDIR,
    VALIDATE_CONFIG_PLAYBOOK,
    VALIDATE_CONFIG_WORKDIR,
)
