...
# =============================================================================
# 1. RUN OIM_CLEANUP PLAYBOOK (LIVE STREAMING)
# =============================================================================
...
def test_run_oim_cleanup_playbook(host):
    """
    Deploy: Run oim_cleanup.yml playbook with live streaming output.

    Executes the full oim_cleanup playbook inside omnia_core container.
    ...
    """
    log = TestLogger("Deploy: oim_cleanup.yml")
