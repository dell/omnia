...
"""
Build Image x86_64 — Playbook Deployment Test.

Runs the build_image_x86_64.yml playbook inside omnia_core container using the
...
Usage:
    run_validation build_image_x86_64 deploy       # Run playbook only
    run_validation build_image_x86_64 test         # Run playbook + all verification tests
    run_validation build_image_x86_64 verify       # Run verification tests only (skip deploy)
"""
...
# =============================================================================
# 1. RUN BUILD_IMAGE_X86_64 PLAYBOOK (LIVE STREAMING)
# =============================================================================

@pytest.mark.deploy
@pytest.mark.order(1)
def test_run_build_image_x86_64_playbook(host):
    """
    Deploy: Run build_image_x86_64.yml playbook with live streaming output.

    Executes the full build_image_x86_64 playbook inside omnia_core container.
