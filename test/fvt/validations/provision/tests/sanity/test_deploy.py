...
"""
Provision — Playbook Deployment Test.

Runs the provision.yml playbook inside omnia_core container using the
...
Usage:
    run_validation provision deploy       # Run playbook only
    run_validation provision test         # Run playbook + all verification tests
    run_validation provision verify       # Run verification tests only (skip deploy)
"""
...
# =============================================================================
# 1. RUN PROVISION PLAYBOOK (LIVE STREAMING)
# =============================================================================

@pytest.mark.deploy
@pytest.mark.order(1)
def test_run_provision_playbook(host):
    """
    Deploy: Run provision.yml playbook with live streaming output.

    Executes the full provision playbook inside omnia_core container.
