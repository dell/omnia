...
from generate_catalog import _generate_human_readable_id  # noqa: E402, C0413
...
class TestGenerateHumanReadableId(unittest.TestCase):
    ...
    def test_version_in_name_exact(self):
        """Test stripping exact version suffix when pkg_version is provided."""
        self.assertEqual(
            _generate_human_readable_id(
    ...
    def test_version_in_name_v_prefixed(self):
        """Test stripping version when 'v' prefix is in name but not in version."""
        self.assertEqual(
    ...
    def test_pip_module_format(self):
        """Test pip module format with version in name (PyMySQL==1.1.2)."""
        self.assertEqual(
    ...
    def test_regex_fallback_no_version(self):
        """Test regex version stripping when pkg_version is not provided."""
        self.assertEqual(
    ...
    def test_docker_image_without_tag_in_name(self):
        """Test docker images where tag is not in the name field."""
        self.assertEqual(
            _generate_human_readable_id(
    ...
    def test_collision_handling(self):
        """Test collision handling by appending _1, _2, etc. to duplicate IDs."""
