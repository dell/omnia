...
| iso_file_path [Required]                                                         | **/root/Rocky-8.4-x86_64-minimal.iso**            | This   is the path where the user has to place the iso image that needs to be   provisioned in target nodes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
