...
.. note:: Avoid whitespaces when using an LDIF file for user creation. Any extra space can affect the input data ,which might be misunderstood by OpenLDAP encryption mechanism.
