...
2. Run the command ``ldapadd -D <enter admin database username> -w <admin database password> -f create_user.ldif`` to execute the LDIF file and create the account.
