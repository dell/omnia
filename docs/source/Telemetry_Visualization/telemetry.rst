...
A lot of these metrics are collected using iDRAC telemetry. iDRAC telemetry allows you to stream telemetry data from your servers to a centralized log/metrics server. For more information on iDRAC telemetry, click `here <https://github.com/dell/iDRAC-Telemetry-Reference-Tools>`_.
...
2. To update the configuration before running ``telemetry.yml``, fill out the parameters listed here:

.. include:: telemetryparameters.rst
