...
* Ensure that there is at least 50% (~35GB) free space on the Control Plane before running Omnia (Place required ISO and any other larger files in the home directory ``/home`` to maintain the ~35GB free space required in the root directory).
