...
* Use a `PXE mapping file <OmniaInstallGuide/samplefiles.html>`_ even when using DHCP configuration to ensure that IP assignments remain persistent across Control Plane reboots.
