...
.. caution:: To run Omnia, it is crucial to use the Python virtual environment created by the ``prereq.sh`` script. Do not delete the virtual environment as it is necessary for the proper functioning of Omnia.
