...
.. note:: This playbook has been tested on the RHEL 8.8 OS platform.
...
* Ensure the system has enough available space. (Approximately 100GB is required for the vLLM image. Any additional scripting will take disk capacity outside the image.)
